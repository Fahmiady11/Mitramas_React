    ...
    <>
      <div className="flex items-center justify-end gap-3 mt-6">
        ...
        <button
          ...
          className="shadow-lg px-6 py-1.5 bg-orange-500 rounded-md border-orange-500 border-2 text-white font-bold hover:bg-orange-600 hover:text-white hover:border-orange-500"
        >
          Kirim
        </button>
      </div>
